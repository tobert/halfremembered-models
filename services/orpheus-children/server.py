#!/usr/bin/env python3
"""
Orpheus Children - Generate children's songs.
...
app = FastAPI(
    title="Orpheus Children",
    description="Generate children's songs",
    version="2.0.0",
    lifespan=lifespan,
)
...
class ChildrenRequest(BaseModel):
    """Request to generate children's music."""
...
if __name__ == "__main__":
    ...
    print(f"🧒 Starting Orpheus Children on port {PORT}...")
    print("Endpoints:")
